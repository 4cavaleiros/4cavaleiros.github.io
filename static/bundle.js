...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  var date = new Date(1418293867 * 1000);
	  console.log(_moment2.default);
	  console.log((0, _moment2.default)());
	  console.log((0, _moment2.default)().subtract(3, 'months'));
	  console.log((0, _moment2.default)().subtract(1, 'days'));
	  console.log((0, _moment2.default)(new Date(1418293867 * 1000)));
	  console.log((0, _moment2.default)(date));
	  ...
	  var scrollTo = function scrollTo(to) {
	    _jquery2.default.scrollTo(to, 1000, { easing: 'easeInOutExpo', offset: 0, 'axis': 'y' });
	  };
	
	  (0, _jquery2.default)('.home--btn').click(function (e) {
	    console.log('Clicked');
	    scrollTo('body');
	  });
	  ...
	  (0, _jquery2.default)('.team--btn').click(function (e) {
	    scrollTo('#team');
	  });
	});
